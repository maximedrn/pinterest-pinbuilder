...
LICENSE_KEY_NOT_VALID: Final[str] = 'The license key is not valid.'
LICENSE_KEY_PROCESS_RUNNING: Final[str] = (
    'It is not possible to change the license key while a process '
    'is running.')
TOOL_NOT_ACTIVATED: Final[str] = 'Please activate the tool.'

# About the update.
UPDATE_ERROR: Final[str] = 'An error occurred while fetching the new update.'
UPDATE_PROCESS_RUNNING: Final[str] = (
...
DATETIME_SCHEDULE_ERROR: Final[str] = (
    'The schedule must be less than 14 days.')
