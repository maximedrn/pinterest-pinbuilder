...
from webdriver_manager.core.os_manager import OperationSystemManager as OSM

from app.constants.messages import (
    WEBDRIVER,
    WEBDRIVER_DOWNLOAD,
    WEBDRIVER_DOWNLOAD_ERROR,
    WEBDRIVER_DOWNLOADED,
    WEBDRIVER_NOT_PATCHED,
    WEBDRIVER_PATCHED,
    WEBDRIVER_PATCHING,
    WEBDRIVER_PATH_SET,
    WEBDRIVER_SIGNED,
    WEBDRIVER_SIGNING,
    WEBDRIVER_SIGNING_ERROR,
)
from app.constants.paths import ASSETS_FOLDER, WEBDRIVER_FILE
from app.constants.processes import LOGIN_PROCESS, MANAGER_PROCESSES
...
class WebdriverManager:
    ...
    def __download_webdriver(self) -> bool:
        ...
        try:  # Attempt to download the webdriver using the `CDM()` class.
            ...
            self.__browser_path: str = CDM(  # CDM downloads the webdriver.
                cache_manager=DCM(root_dir=ASSETS_FOLDER)
            ).install()
    ...
    def __set_up_new_webdriver(self, manager: DictProxy[Any, Any]) -> None:
        ...
        self.driver: Chrome = Chrome(  # Initialize the Chrome webdriver.
            log_level=0,
            driver_executable_path=self.__browser_path,
            options=chrome_options,
            version_main=self.__chrome_version,
        )
